...
<body>
	...
	<fieldset
		...
		<h3 class="error" align="center">OOPS! Something went wrong, our developers are on it!</h3>
		<br><br>
		<div align="center">
			<a href="/home" class="error"><button>CLICK HERE to go to main page</button></a>
		</div>
		<!--<p>Following is the error (for testing purpose)</p>
		<div>
		${error}
		</div> -->
	</fieldset>
