...
<!-- site metas -->
<title>Race to Life | Reset Password</title>
<meta name="keywords"
...
<body>
	...
	<fieldset
		...
		<form method="post" action="/reset-password-web" name="reset-password-web">
			<table>
				<tr>
					<th colspan=2>
				...
				<tr>
					<th colspan=2>
							<h3 class="error" align="center">${errorMessage}</h3>
							<h3 class="error" align="center">${newUserMessage}</h3>
							<h3 class="msg" align="center">${userPassword}</h3>
					</th>
				</tr>
				<tr>
					<th><input type="reset" name="reset" value="Clear"></th>
					<th><input type="submit" name="commit" value="Submit"></th>
				</tr>
			</table>
			<br>
			<div align=center>
				<p>
					Return to login page <a href="/loginWeb">Click here to Login</a>.
				</p>
			</div>
		</form>
	</fieldset>
    ...
    window.onload = function(){
    	...
    	if(newUser!=""){
    		alert(newUser);
    		window.location.pathname = '/registerWeb';
    	}
    }
    </script>
</body>
